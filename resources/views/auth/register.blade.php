      ...
      <div class="card-body p-0">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 logo-container">
            <img src="{{ asset('assets/logo-universitas-bina-sarana-informatika-ubsi.png') }}"
                 alt="Logo Universitas Bina Sarana Informatika (UBSI)">
          </div>
            ...
            <div class="p-5">
              ...
              <form action="{{ route('register.simpan') }}" method="POST" class="user">
                ...
                <div class="form-group">
                  <input name="nama" type="text" class="form-control form-control-user @error('nama') is-invalid @enderror" placeholder="Full Name">
                  @error('nama')
